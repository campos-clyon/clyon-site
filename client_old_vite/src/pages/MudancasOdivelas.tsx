...
export default function MudancasOdivelas() {
  return (
    <ServiceCityPage
      service="Mudanças"
      city="Odivelas"
      description="Serviço profissional de mudanças residenciais e comerciais em Odivelas. A CLYON trata de tudo: embalagem, desmontagem, transporte e montagem no novo espaço. Mudanças rápidas, seguras e a preços competitivos."
      whatIncludes={[
      ...
      pricing="O preço das mudanças em Odivelas depende do volume, distância e serviços incluídos. Uma mudança de T1 custa entre €200-400, T2 entre €350-600, T3 a partir de €500. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa uma mudança em Odivelas?",
        ...
        {
          question: "Fazem mudanças no mesmo dia em Odivelas?",
          answer: "Sim! Conforme disponibilidade, podemos fazer mudanças no mesmo dia em Odivelas. Entre em contacto pela manhã.",
        },
        {
        ...
        },
        {
          ...
          answer: "Sim, fazemos mudanças residenciais e comerciais em Odivelas. Temos experiência em mudanças de escritórios, lojas e armazéns.",
        },
        {
      ...
      testimonials={[
        {
          name: "Luísa P.",
          text: "Mudança em Odivelas feita de forma rápida e profissional. A CLYON tratou de tudo, desde a embalagem até à montagem.",
          rating: 5,
        },
        {
          name: "Rui M.",
          text: "Excelente serviço de mudanças em Odivelas. Preço justo, equipa simpática e muito cuidadosa com os móveis.",
          rating: 5,
        },
        {
          name: "Catarina S.",
          text: "Recomendo a CLYON para mudanças em Odivelas. Profissionais, pontuais e muito eficientes.",
          rating: 5,
        }
      ]}
    />
