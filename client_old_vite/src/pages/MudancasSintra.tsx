...
export default function MudancasSintra() {
  return (
    <ServiceCityPage
      service="Mudanças"
      city="Sintra"
      description="Serviço profissional de mudanças residenciais e comerciais em Sintra. A CLYON trata de tudo: embalagem, desmontagem, transporte e montagem no novo espaço. Mudanças rápidas, seguras e a preços competitivos."
      whatIncludes={[
      ...
      pricing="O preço das mudanças em Sintra depende do volume, distância e serviços incluídos. Uma mudança de T1 custa entre €200-400, T2 entre €350-600, T3 a partir de €500. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa uma mudança em Sintra?",
        ...
        {
          question: "Fazem mudanças no mesmo dia em Sintra?",
          answer: "Sim! Conforme disponibilidade, podemos fazer mudanças no mesmo dia em Sintra. Entre em contacto pela manhã.",
        },
        {
        ...
        },
        {
          ...
          answer: "Sim, fazemos mudanças residenciais e comerciais em Sintra. Temos experiência em mudanças de escritórios, lojas e armazéns.",
        },
        {
      ...
      testimonials={[
        {
          name: "Luísa P.",
          text: "Mudança em Sintra feita de forma rápida e profissional. A CLYON tratou de tudo, desde a embalagem até à montagem.",
          rating: 5,
        },
        {
          name: "Rui M.",
          text: "Excelente serviço de mudanças em Sintra. Preço justo, equipa simpática e muito cuidadosa com os móveis.",
          rating: 5,
        },
        {
          name: "Catarina S.",
          text: "Recomendo a CLYON para mudanças em Sintra. Profissionais, pontuais e muito eficientes.",
          rating: 5,
        }
      ]}
    />
