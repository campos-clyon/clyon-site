...
export default function RecolhaEntulhoCarnaxide() {
  return (
    <ServiceCityPage
      service="Recolha de Entulho"
      city="Carnaxide"
      description="Serviço profissional de recolha e remoção de entulho em Carnaxide. Removemos entulho de obras, construção e reformas com transporte responsável, separação seletiva e descarte legal certificado. Resposta em 11 minutos."
      whatIncludes={[
      ...
      pricing="O preço da recolha de entulho em Carnaxide depende do volume (m³) e tipo de material. Recolhas pequenas (1-2m³) custam entre €80-150, médias (3-5m³) entre €150-300, e grandes (6m³+) a partir de €300. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa a recolha de entulho em Carnaxide?",
        ...
        {
          question: "Fazem recolha de entulho no mesmo dia em Carnaxide?",
          answer: "Sim! Conforme disponibilidade, podemos fazer recolhas no mesmo dia em Carnaxide. Entre em contacto pela manhã.",
        },
        {
          question: "O descarte é legal e certificado em Carnaxide?",
        ...
        },
        {
          ...
          answer: "Sim, recolhemos entulho de obras de remodelação, construção, demolição e reformas em Carnaxide.",
        },
        {
      ...
      testimonials={[
        {
          name: "Miguel T.",
          text: "Recolheram o entulho da minha obra em Carnaxide de forma rápida e profissional. Muito satisfeito!",
          rating: 5,
        },
        {
          name: "Paula N.",
          text: "Excelente serviço em Carnaxide. Orçamento rápido, preço justo e trabalho impecável.",
          rating: 5,
        },
        {
          name: "António L.",
          text: "Recomendo a CLYON para recolha de entulho em Carnaxide. Profissionais e pontuais.",
          rating: 5,
        }
      ]}
    />
