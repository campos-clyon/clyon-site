...
export default function MudancasCascais() {
  return (
    <ServiceCityPage
      service="Mudanças"
      city="Cascais"
      description="Serviço profissional de mudanças residenciais e comerciais em Cascais. A CLYON trata de tudo: embalagem, desmontagem, transporte e montagem no novo espaço. Mudanças rápidas, seguras e a preços competitivos."
      whatIncludes={[
      ...
      pricing="O preço das mudanças em Cascais depende do volume, distância e serviços incluídos. Uma mudança de T1 custa entre €200-400, T2 entre €350-600, T3 a partir de €500. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa uma mudança em Cascais?",
        ...
        {
          question: "Fazem mudanças no mesmo dia em Cascais?",
          answer: "Sim! Conforme disponibilidade, podemos fazer mudanças no mesmo dia em Cascais. Entre em contacto pela manhã.",
        },
        {
        ...
        },
        {
          ...
          answer: "Sim, fazemos mudanças residenciais e comerciais em Cascais. Temos experiência em mudanças de escritórios, lojas e armazéns.",
        },
        {
      ...
      testimonials={[
        {
          name: "Luísa P.",
          text: "Mudança em Cascais feita de forma rápida e profissional. A CLYON tratou de tudo, desde a embalagem até à montagem.",
          rating: 5,
        },
        {
          name: "Rui M.",
          text: "Excelente serviço de mudanças em Cascais. Preço justo, equipa simpática e muito cuidadosa com os móveis.",
          rating: 5,
        },
        {
          name: "Catarina S.",
          text: "Recomendo a CLYON para mudanças em Cascais. Profissionais, pontuais e muito eficientes.",
          rating: 5,
        }
      ]}
    />
