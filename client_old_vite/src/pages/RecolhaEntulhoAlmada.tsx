...
export default function RecolhaEntulhoAlmada() {
  return (
    <ServiceCityPage
      service="Recolha de Entulho"
      city="Almada"
      description="Serviço profissional de recolha e remoção de entulho em Almada. Removemos entulho de obras, construção e reformas com transporte responsável, separação seletiva e descarte legal certificado. Resposta em 11 minutos."
      whatIncludes={[
      ...
      pricing="O preço da recolha de entulho em Almada depende do volume (m³) e tipo de material. Recolhas pequenas (1-2m³) custam entre €80-150, médias (3-5m³) entre €150-300, e grandes (6m³+) a partir de €300. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa a recolha de entulho em Almada?",
        ...
        },
        {
          ...
          answer: "Sim, recolhemos entulho de obras de remodelação, construção, demolição e reformas em Almada.",
        },
        {
      ...
      testimonials={[
        {
          name: "Miguel T.",
          text: "Recolheram o entulho da minha obra em Almada de forma rápida e profissional. Muito satisfeito!",
          rating: 5,
        },
        {
          name: "Paula N.",
          text: "Excelente serviço em Almada. Orçamento rápido, preço justo e trabalho impecável.",
          rating: 5,
        },
        {
          name: "António L.",
          text: "Recomendo a CLYON para recolha de entulho em Almada. Profissionais e pontuais.",
          rating: 5,
        }
      ]}
    />
