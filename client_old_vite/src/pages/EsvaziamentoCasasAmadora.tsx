...
export default function EsvaziamentoCasasAmadora() {
  return (
    <ServiceCityPage
      service="Esvaziamento de Casas"
      city="Amadora"
      description="Serviço profissional de esvaziamento de casas, apartamentos e vivendas em Amadora. Removemos todos os móveis, eletrodomésticos, monos e entulho, deixando o espaço completamente limpo e pronto para venda, arrendamento ou renovação."
      whatIncludes={[
      ...
      pricing="O preço do esvaziamento de casas em Amadora depende da dimensão do espaço (T0, T1, T2, T3+) e quantidade de itens. Em média, um T1 custa entre €200-400, um T2 entre €350-600, e um T3 a partir de €500. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa o esvaziamento de uma casa em Amadora?",
        ...
        {
          question: "Fazem esvaziamento no mesmo dia em Amadora?",
          answer: "Sim! Conforme disponibilidade, podemos fazer esvaziamentos no mesmo dia em Amadora. Entre em contacto pela manhã para maior probabilidade.",
        },
        {
      ...
      testimonials={[
        {
          name: "Ana S.",
          text: "Excelente serviço! Esvaziaram o apartamento da minha mãe em Amadora em menos de 4 horas. Profissionais, rápidos e deixaram tudo limpo.",
          rating: 5,
        },
        {
          name: "Carlos M.",
          text: "Precisava de esvaziar uma vivenda em Amadora para venda. A CLYON fez tudo num dia, incluindo a limpeza. Recomendo!",
          rating: 5,
        },
        {
          name: "Maria F.",
          text: "Serviço impecável. Orçamento rápido, preço justo e trabalho bem feito em Amadora.",
          rating: 5,
        }
      ]}
    />
