...
export default function LimpezaPosObraAmadora() {
  return (
    <ServiceCityPage
      service="Limpeza Pós-Obra"
      city="Amadora"
      description="Serviço profissional de limpeza pós-obra em Amadora. Após obras, remodelações ou construção, a CLYON deixa o espaço completamente limpo e pronto a usar no mesmo dia. Remoção de pó, resíduos, tinta e sujidade de obra."
      whatIncludes={[
      ...
      pricing="O preço da limpeza pós-obra em Amadora depende da área (m²) e grau de sujidade. Em média, um T1 custa entre €150-300, um T2 entre €250-450, e um T3 a partir de €400. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa a limpeza pós-obra em Amadora?",
        ...
        {
          question: "Fazem limpeza pós-obra no mesmo dia em Amadora?",
          answer: "Sim! Conforme disponibilidade, podemos fazer limpezas no mesmo dia em Amadora. Entre em contacto pela manhã.",
        },
        {
        ...
        },
        {
          ...
          answer: "Sim, fazemos limpeza pós-obra em apartamentos, moradias, escritórios e espaços comerciais em Amadora.",
        }
      ]}
      testimonials={[
        {
          name: "Pedro A.",
          text: "Fizeram a limpeza pós-obra do meu apartamento em Amadora de forma impecável. Ficou como novo!",
          rating: 5,
        },
        {
          name: "Sofia R.",
          text: "Excelente trabalho! Remodelei a cozinha e a CLYON limpou tudo em Amadora no mesmo dia. Muito profissionais.",
          rating: 5,
        },
        {
          name: "João C.",
          text: "Serviço de qualidade a bom preço em Amadora. Recomendo a toda a gente que precise de limpeza pós-obra.",
          rating: 5,
        }
      ]}
    />
