...
export default function EsvaziamentoCasasLoures() {
  return (
    <ServiceCityPage
      service="Esvaziamento de Casas"
      city="Loures"
      description="Serviço profissional de esvaziamento de casas, apartamentos e vivendas em Loures. Removemos todos os móveis, eletrodomésticos, monos e entulho, deixando o espaço completamente limpo e pronto para venda, arrendamento ou renovação."
      whatIncludes={[
      ...
      pricing="O preço do esvaziamento de casas em Loures depende da dimensão do espaço (T0, T1, T2, T3+) e quantidade de itens. Em média, um T1 custa entre €200-400, um T2 entre €350-600, e um T3 a partir de €500. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa o esvaziamento de uma casa em Loures?",
        ...
        {
          question: "Fazem esvaziamento no mesmo dia em Loures?",
          answer: "Sim! Conforme disponibilidade, podemos fazer esvaziamentos no mesmo dia em Loures. Entre em contacto pela manhã para maior probabilidade.",
        },
        {
      ...
      testimonials={[
        {
          name: "Ana S.",
          text: "Excelente serviço! Esvaziaram o apartamento da minha mãe em Loures em menos de 4 horas. Profissionais, rápidos e deixaram tudo limpo.",
          rating: 5,
        },
        {
          name: "Carlos M.",
          text: "Precisava de esvaziar uma vivenda em Loures para venda. A CLYON fez tudo num dia, incluindo a limpeza. Recomendo!",
          rating: 5,
        },
        {
          name: "Maria F.",
          text: "Serviço impecável. Orçamento rápido, preço justo e trabalho bem feito em Loures.",
          rating: 5,
        }
      ]}
    />
