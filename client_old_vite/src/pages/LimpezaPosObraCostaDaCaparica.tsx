...
export default function LimpezaPosObraCostaDaCaparica() {
  return (
    <ServiceCityPage
      service="Limpeza Pós-Obra"
      city="Costa da Caparica"
      description="Serviço profissional de limpeza pós-obra em Costa da Caparica. Após obras, remodelações ou construção, a CLYON deixa o espaço completamente limpo e pronto a usar no mesmo dia. Remoção de pó, resíduos, tinta e sujidade de obra."
      whatIncludes={[
      ...
      pricing="O preço da limpeza pós-obra em Costa da Caparica depende da área (m²) e grau de sujidade. Em média, um T1 custa entre €150-300, um T2 entre €250-450, e um T3 a partir de €400. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa a limpeza pós-obra em Costa da Caparica?",
        ...
        {
          question: "Fazem limpeza pós-obra no mesmo dia em Costa da Caparica?",
          answer: "Sim! Conforme disponibilidade, podemos fazer limpezas no mesmo dia em Costa da Caparica. Entre em contacto pela manhã.",
        },
        {
        ...
        },
        {
          ...
          answer: "Sim, fazemos limpeza pós-obra em apartamentos, moradias, escritórios e espaços comerciais em Costa da Caparica.",
        }
      ]}
      testimonials={[
        {
          name: "Pedro A.",
          text: "Fizeram a limpeza pós-obra do meu apartamento em Costa da Caparica de forma impecável. Ficou como novo!",
          rating: 5,
        },
        {
          name: "Sofia R.",
          text: "Excelente trabalho! Remodelei a cozinha e a CLYON limpou tudo em Costa da Caparica no mesmo dia. Muito profissionais.",
          rating: 5,
        },
        {
          name: "João C.",
          text: "Serviço de qualidade a bom preço em Costa da Caparica. Recomendo a toda a gente que precise de limpeza pós-obra.",
          rating: 5,
        }
      ]}
    />
