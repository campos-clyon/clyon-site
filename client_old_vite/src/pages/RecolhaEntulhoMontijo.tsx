...
export default function RecolhaEntulhoMontijo() {
  return (
    <ServiceCityPage
      service="Recolha de Entulho"
      city="Montijo"
      description="Serviço profissional de recolha e remoção de entulho em Montijo. Removemos entulho de obras, construção e reformas com transporte responsável, separação seletiva e descarte legal certificado. Resposta em 11 minutos."
      whatIncludes={[
      ...
      pricing="O preço da recolha de entulho em Montijo depende do volume (m³) e tipo de material. Recolhas pequenas (1-2m³) custam entre €80-150, médias (3-5m³) entre €150-300, e grandes (6m³+) a partir de €300. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa a recolha de entulho em Montijo?",
        ...
        },
        {
          ...
          answer: "Sim, recolhemos entulho de obras de remodelação, construção, demolição e reformas em Montijo.",
        },
        {
      ...
      testimonials={[
        {
          name: "Miguel T.",
          text: "Recolheram o entulho da minha obra em Montijo de forma rápida e profissional. Muito satisfeito!",
          rating: 5,
        },
        {
          name: "Paula N.",
          text: "Excelente serviço em Montijo. Orçamento rápido, preço justo e trabalho impecável.",
          rating: 5,
        },
        {
          name: "António L.",
          text: "Recomendo a CLYON para recolha de entulho em Montijo. Profissionais e pontuais.",
          rating: 5,
        }
      ]}
    />
