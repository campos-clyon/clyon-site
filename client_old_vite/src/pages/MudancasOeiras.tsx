...
export default function MudancasOeiras() {
  return (
    <ServiceCityPage
      service="Mudanças"
      city="Oeiras"
      description="Serviço profissional de mudanças residenciais e comerciais em Oeiras. A CLYON trata de tudo: embalagem, desmontagem, transporte e montagem no novo espaço. Mudanças rápidas, seguras e a preços competitivos."
      whatIncludes={[
      ...
      pricing="O preço das mudanças em Oeiras depende do volume, distância e serviços incluídos. Uma mudança de T1 custa entre €200-400, T2 entre €350-600, T3 a partir de €500. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa uma mudança em Oeiras?",
        ...
        {
          question: "Fazem mudanças no mesmo dia em Oeiras?",
          answer: "Sim! Conforme disponibilidade, podemos fazer mudanças no mesmo dia em Oeiras. Entre em contacto pela manhã.",
        },
        {
        ...
        },
        {
          ...
          answer: "Sim, fazemos mudanças residenciais e comerciais em Oeiras. Temos experiência em mudanças de escritórios, lojas e armazéns.",
        },
        {
      ...
      testimonials={[
        {
          name: "Luísa P.",
          text: "Mudança em Oeiras feita de forma rápida e profissional. A CLYON tratou de tudo, desde a embalagem até à montagem.",
          rating: 5,
        },
        {
          name: "Rui M.",
          text: "Excelente serviço de mudanças em Oeiras. Preço justo, equipa simpática e muito cuidadosa com os móveis.",
          rating: 5,
        },
        {
          name: "Catarina S.",
          text: "Recomendo a CLYON para mudanças em Oeiras. Profissionais, pontuais e muito eficientes.",
          rating: 5,
        }
      ]}
    />
