...
export default function RecolhaMonosOdivelas() {
  return (
    <ServiceCityPage
      service="Recolha de Monos"
      city="Odivelas"
      description="Serviço profissional de recolha de monos ao domicílio em Odivelas. Removemos móveis velhos, eletrodomésticos, objetos volumosos e tralha doméstica de forma rápida e económica. Orçamento gratuito em 11 minutos."
      whatIncludes={[
      ...
      pricing="O preço da recolha de monos em Odivelas depende da quantidade e tipo de itens. Uma recolha pequena (1-3 itens) custa entre €40-80, média (4-8 itens) entre €80-150, e grande (9+ itens) a partir de €150. Orçamento sempre gratuito."
      ...
      faqs={[
        {
          question: "Quanto custa a recolha de monos em Odivelas?",
        ...
        {
          question: "Fazem recolha de monos no mesmo dia em Odivelas?",
          answer: "Sim! Conforme disponibilidade, podemos fazer recolhas no mesmo dia em Odivelas. Entre em contacto pela manhã.",
        },
        {
          question: "Recolhem eletrodomésticos velhos em Odivelas?",
          answer: "Sim, recolhemos eletrodomésticos velhos, incluindo frigoríficos, máquinas de lavar, fogões e micro-ondas em Odivelas.",
        },
        {
        ...
        },
        {
          ...
          answer: "Não é necessário acesso especial. Trabalhamos em apartamentos, moradias e espaços comerciais em Odivelas.",
        }
      ]}
      testimonials={[
        {
          name: "Helena V.",
          text: "Recolheram os monos do meu apartamento em Odivelas de forma rápida e profissional. Muito satisfeita!",
          rating: 5,
        },
        {
          name: "Bruno A.",
          text: "Excelente serviço em Odivelas. Levaram tudo em poucas horas e ainda fizeram doação dos itens em bom estado.",
          rating: 5,
        },
        {
          name: "Filipa C.",
          text: "Recomendo a CLYON para recolha de monos em Odivelas. Preço justo e trabalho impecável.",
          rating: 5,
        }
      ]}
    />
