  ...
  return (
    <ServiceCityPage
      ...
      whatIncludes={[
        ...
        "Atendimento em toda a região de Amora e arredores",
      ...
      pricing="O preço varia conforme o volume, peso e dificuldade de acesso. Em média: sofá 2-3 lugares (€35-55), armário grande (€45-75), cama de casal (€25-45), mesa + cadeiras (€35-55), frigorífico/máquina de lavar (€30-50). Recolha de conjunto completo de apartamento: €180-350. Preços em Amora podem variar conforme a localização. Orçamento sempre gratuito e sem compromisso."
      timeline="Resposta ao orçamento em até 11 minutos. Recolha pode ser agendada para o mesmo dia (conforme disponibilidade) ou data de sua preferência, incluindo sábados. Atendemos Amora e arredores. Serviço completo dura entre 30 minutos a 2 horas, dependendo da quantidade e localização dos móveis."
      legal="Móveis em condições de uso são doados a instituições de caridade parceiras em Amora (IPSS, associações locais, Cáritas). Móveis danificados são transportados para centros de triagem certificados pela APA, onde madeira, metal e plástico são separados para reciclagem. Cumprimos o Decreto-Lei n.º 178/2006 sobre gestão de resíduos. Fornecemos guias de transporte quando solicitado."
      faqs={[
        {
          question: "Quanto custa recolher um sofá em Amora?",
          answer: "Um sofá de 2-3 lugares custa entre €35-55. Sofás maiores ou de canto podem custar €60-90. O preço inclui carregamento, transporte e descarte legal. Preços em Amora podem variar. Envie foto via WhatsApp para orçamento exato.",
        },
        {
          question: "Vocês atendem toda a região de Amora?",
          answer: "Sim! Atendemos toda a região de Amora e arredores. Informe a localização exata no orçamento para confirmar se sua zona está incluída.",
        },
        {
        ...
        {
          question: "Recolhem eletrodomésticos em Amora?",
        ...
        },
        {
          ...
          answer: "Móveis em bom estado são doados a instituições sociais em Amora (IPSS, Cáritas). Móveis danificados vão para centros de reciclagem certificados, onde madeira, metal e plástico são separados e reciclados.",
        },
      ]}
      testimonials={[
        {
          name: "Cliente em Amora",
          text: "Serviço excelente! Recolheram móveis em Amora. Rápidos, simpáticos e preço justo. Recomendo!",
          rating: 5,
        },
        {
          name: "Cliente satisfeito em Amora",
          text: "Precisava recolher móveis em Amora. Vieram no dia seguinte e fizeram tudo impecável. Muito satisfeito!",
          rating: 5,
        },
        {
          name: "Referência em Amora",
          text: "Recolheram móveis antigos em Amora. Equipa profissional, trabalho rápido e preço melhor que esperava!",
          rating: 5,
        },
      ]}
    />
