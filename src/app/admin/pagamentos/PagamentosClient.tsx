...
export default function PagamentosClient() {
  ...
  // Expandir detalhe de um assistente
    ...
    <div className="min-h-full px-4 py-6 md:px-8 md:py-8">
      ...
      <div className="mb-7 flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-2.5 text-sm font-medium text-slate-300 hover:bg-white/[0.07] disabled:opacity-50 transition"
        >
        ...
        {periodo === "personalizado" && (
          <div className="flex items-center gap-2">
            <input
              ...
              className="rounded-2xl border border-white/10 bg-[#111827] px-3 py-2 text-sm text-white focus:border-[#00B4D8]/40 focus:outline-none transition"
            />
            ...
            <button
              onClick={fetchPagamentos}
              className="rounded-2xl bg-[#00B4D8] px-4 py-2 text-sm font-bold text-slate-950 hover:bg-[#00C8F0] transition"
            >
              Aplicar
            </button>
          </div>
      ...
      {!loading && pagamentos.length > 0 && (
        <div className="mb-6 grid grid-cols-2 gap-4 sm:grid-cols-3">
          <div className="rounded-[20px] border border-[#00B4D8]/20 bg-[#00B4D8]/[0.06] p-5">
          ...
          <div className="rounded-[20px] border border-[#06D6A0]/20 bg-[#06D6A0]/[0.06] p-5">
        ...
        <div className="space-y-3">
          {pagamentos.map((p) => {
            ...
            return (
              <div
                key={p.assistenteId}
                className="rounded-[22px] border border-white/[0.07] bg-white/[0.02] overflow-hidden"
              >
                {/* Row resumo */}
                <button
                  type="button"
                ...
                >
                  {/* Avatar */}
                  <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-[14px] bg-[#0077B6]/20 text-sm font-bold text-[#00B4D8]">
                ...
                {isOpen && (
                  <div className="border-t border-white/[0.06] px-5 py-4 space-y-2">
                    ...
                    {p.trabalhos.map((t) => (
                      <div
                        key={t.pedidoId}
                        className="flex items-center gap-3 rounded-[14px] border border-white/[0.05] bg-white/[0.02] px-4 py-3"
                      >
                        {/* Pedido ID */}
