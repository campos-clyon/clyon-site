          ...
          <div className="grid items-center gap-9 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="max-w-lg">
              ...
              <div className="mt-6 flex flex-col gap-2 sm:flex-row">
                <Link
                  href="/simulador"
                  className="inline-flex h-[46px] items-center justify-center rounded-xl bg-cyan-600 px-6 text-sm font-semibold text-white shadow-lg shadow-cyan-600/25 transition-all hover:-translate-y-0.5 hover:bg-cyan-700 hover:shadow-xl"
                >
                ...
                <a
                  ...
                  className="inline-flex h-[46px] items-center justify-center gap-2 rounded-xl bg-emerald-500 px-6 text-sm font-semibold text-white shadow-lg shadow-emerald-500/25 transition-all hover:-translate-y-0.5 hover:bg-emerald-600 hover:shadow-xl"
                >
