          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="max-w-xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link 
                  href="/contactos" 
                  className="inline-flex h-11 items-center justify-center rounded-lg bg-cyan-600 px-5 text-sm font-semibold text-white transition hover:bg-cyan-700"
                >
                ...
                <a
                  ...
                  className="inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-emerald-500 bg-emerald-500 px-5 text-sm font-semibold text-white transition hover:bg-emerald-600"
                >
