...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="relative min-h-[590px] overflow-hidden bg-gradient-to-b from-slate-50 to-white md:min-h-[680px]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.08),transparent_50%)]" />

        <div className="relative z-10 mx-auto max-w-7xl px-4 pb-16 pt-14 sm:px-6 sm:pt-16 lg:px-8 lg:pb-24 lg:pt-20">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <div className="max-w-lg">
              ...
              <h1 className="text-balance text-[1.875rem] font-bold leading-[1.15] tracking-tight text-slate-900 sm:text-[2.375rem] lg:text-[2.625rem]">
              ...
              <div className="mt-7 flex flex-col gap-2.5 sm:flex-row">
                <Link
                  href="/simulador"
                  className="inline-flex h-[52px] items-center justify-center rounded-xl bg-cyan-600 px-7 text-[0.9375rem] font-semibold text-white shadow-lg shadow-cyan-600/25 transition-all hover:-translate-y-0.5 hover:bg-cyan-700 hover:shadow-xl"
                >
                ...
                <a
                  ...
                  className="inline-flex h-[52px] items-center justify-center gap-2 rounded-xl bg-emerald-500 px-7 text-[0.9375rem] font-semibold text-white shadow-lg shadow-emerald-500/25 transition-all hover:-translate-y-0.5 hover:bg-emerald-600 hover:shadow-xl"
                >
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -right-3 -top-3 rounded-lg border border-slate-200 bg-white px-3.5 py-2.5 shadow-md">
                <div className="flex items-center gap-2.5">
                  <div className="flex h-9 w-9 items-center justify-center rounded-md bg-cyan-100">
                    <ShieldCheck className="h-[18px] w-[18px] text-cyan-600" />
                  </div>
                  <div>
                    <div className="text-xs font-semibold text-slate-900">Equipa Profissional</div>
                    <div className="text-[10px] text-slate-500">Lisboa e Setúbal</div>
                  </div>
                </div>
              </div>
              {/* Badge: Resposta Rápida */}
              <div className="absolute -bottom-3 -left-3 rounded-lg border border-slate-200 bg-white px-3.5 py-2.5 shadow-md">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-slate-500">Em 11 minutos</div>
                  </div>
                </div>
              </div>
            </div>
