        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 pb-14 pt-14 lg:px-8 lg:pb-18 lg:pt-18">
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/simulador"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-cyan-600 px-7 text-sm font-semibold text-white shadow-lg shadow-cyan-600/25 transition hover:bg-cyan-700"
              >
              ...
              <a
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-emerald-500 px-7 text-sm font-semibold text-white shadow-lg shadow-emerald-500/25 transition hover:bg-emerald-600"
              >
